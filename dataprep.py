...
# Paths
csv_file_path = '/workspace/multimodal/data/processed_train.csv'  # Path to your CSV file
image_folder_path = '/workspace/multimodal/data/archive/images/train'  # Folder where your images are stored
output_json_file = '/workspace/multimodal/data/processed_train.json'  # Output JSON file
